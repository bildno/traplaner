          ...
          <div class="mypage_section">
            <div class="mypage_section1">
              ...
              <div class="manage_box">
                <a href="/my-page/pwChange">계정관리</a><a style="font-weight: bold"
                  href="/my-page/mytravelboard/${login.nickName}">내 게시물</a><a href="/my-page/mytravel/${login.id}">나의
                  여행</a>
                  ...
                  <nav aria-label="Page navigation example">
                    <ul class="pagination pagination-lg pagination-custom">
                      <c:if test="${maker.prev}">
                        <li class="page-item">
                          <a class="page-link"
                            href="/my-page/mytravelboard/${login.nickName}?pageNo=${maker.begin-1}">&lt;&lt;</a>
                        </li>
                      </c:if>
                      ...
                      <c:forEach var="i" begin="${maker.begin}" end="${maker.end}">
                        <li data-page-num="${i}" class="page-item">
                          <a class="page-link" href="/my-page/mytravelboard/${login.nickName}?pageNo=${i}">${i}</a>
                        </li>
                      </c:forEach>
                      ...
                      <c:if test="${maker.next}">
                        <li class="page-item">
                          <a class="page-link"
                            href="/my-page/mytravelboard/${login.nickName}?pageNo=${maker.end + 1}">&gt;&gt;</a>
                        </li>
                      </c:if>
                    </ul>
                  </nav>
